...
Once launched, a **stroked ∞** appears in the menu bar: it is a black-on-transparent template image,
...
│   ├── pdf2zh-status.png       # committed status bar icon (stroked ∞, black on transparent)

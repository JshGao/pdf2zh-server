...
Once launched, a **solid ∞ pierced by two tilted slots** (a twisted ribbon) appears in the menu bar: it is a black-on-transparent template image,
...
│   ├── pdf2zh-status.png       # committed status bar icon (solid ∞ with two tilted slots, black on transparent)
